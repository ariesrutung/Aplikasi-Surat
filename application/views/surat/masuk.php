			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-content">
						...
						<?php foreach ($data as $key) : ?>
							<div class="modal fade" id="hapusSuratMasuk<?= $key['id_surat_masuk']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<?php foreach ($data as $key) : ?>
							<div class="modal fade" id="lihatSurat<?= $key['id_surat_masuk']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
