                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="nama_lengkap" id="nama_lengkap" type="text" value="<?= $tatakerja['nama_lengkap']; ?>" />
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="jabatan" id="jabatan" type="text" value="<?= $tatakerja['jabatan']; ?>" />
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="tugas" id="tugas" type="text"><?= $tatakerja['tugas']; ?></textarea>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="fungsi" id="fungsi" type="text"><?= $tatakerja['fungsi']; ?></textarea>
