...
class Surat extends CI_Controller
{
    ...
    public function tambah_surat_masuk()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->upload->do_upload('file_surat')) {
                ...
                redirect(base_url("admin/surat/surat_masuk"));
            }
        }
    }
    ...
    public function tambah_surat_keluar()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->upload->do_upload('file_surat')) {
                ...
                $this->session->set_flashdata('success', 'Berhasil Ditambahkan!');
                redirect(base_url("admin/surat/surat_keluar"));
            }
        }
    }
    ...
    public function tambah_surat_keterangan()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->upload->do_upload('file_surat')) {
                ...
                $this->session->set_flashdata('success', 'Berhasil Ditambahkan!');
                redirect(base_url("admin/surat/surat_keterangan"));
            }
        }
    }
    ...
    public function updateStatus($id)
    {
        ...
        redirect(base_url('admin/surat/pengajuan'));
    }
